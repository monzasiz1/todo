# 🧠 BeeQu – KI-gestützte To-Do & Kalender App
...
git init
git add .
git commit -m "Initial commit – BeeQu KI To-Do App"
...
| `DB_POOL_MAX` | Optional: Maximale DB-Verbindungen pro Serverless-Instanz (Empfehlung: `1`) |
