                    ...
                    return (
                      <div
                        ...
                        style={isMobile ? {
                          ...
                          width: spanWidth,
                          maxWidth: spanWidth ? 'none' : '100%',
                          background: isHolidayTask ? 'rgba(217,44,44,0.34)' : ended ? 'rgba(142,142,147,0.22)' : categoryAccent ? `${categoryAccent}70` : t.group_id ? `${t.group_color || '#5856D6'}66` : 'rgba(0, 122, 255, 0.42)',
                          color: ended ? '#4B5563' : '#FFFFFF',
