            ...
            <div className="task-detail-item">
              ...
              <div>
                ...
                <div className="task-detail-time-range">
                  <span className="task-detail-time-chip">{formatTime(task.time)}</span>
                  {task.time_end && (
                    <>
                      <span className="task-detail-time-arrow">→</span>
                      <span className="task-detail-time-chip task-detail-time-chip--end">{formatTime(task.time_end)}</span>
                    </>
                  )}
                </div>
              </div>
