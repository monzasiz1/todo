...
-- Add group_id to notification_log for click-through navigation
ALTER TABLE notification_log ADD COLUMN IF NOT EXISTS group_id INTEGER REFERENCES groups(id) ON DELETE SET NULL;
